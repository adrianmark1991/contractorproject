$(function(){
        //construction card
    var r_const = $('#reveal-construction'),
        rc_const = $('#content-construction-reveal'),
        h_const = $('#hide-construction'),
        c_const = $('#content-construction'),
        //civil card
    ...
    r_const.click(function(){
        c_const.hide();
    });
    r_const.click(function () {
        rc_const.show();
    });
    h_const.click(function () {
        rc_const.hide();
    });
    h_const.click(function () {
        c_const.show();
